...
FinSubProceso
//------------------------------------------------------------- TRAPECIO
SubProceso total4 <- medidas4 ( base5, base4, altura Por Referencia )
...
Proceso calculadoraAreas
	...
	Definir radio, radio2, total1, totalcirculo, total3, total4, base3, base4, base5, altura, area4, total5 Como Real;
	...
	Repetir
		...
		Escribir "pulsa 9 para salir del programa";
		Leer opcion;
		...
		Segun opcion Hacer
			...
			4:
				...
				Escribir "introduce la altura: " Sin Saltar;
				Leer altura;
				total5<-calculoarea4(base4,base5,altura);
				Escribir "el area del trapecio de base menor ",base4, ", de base mayor ",base5, " y de altura ",altura, " es de ", total5;
			9:
